...
local props = {
    ...
    SetVehicleCustomPrimaryColour(vehicle, 98, 18, 118),
    SetVehicleCustomSecondaryColour(vehicle, 30, 29, 34),
    SetVehicleNumberPlateText(vehicle, "Ballas"),
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_ballas:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_ballas:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_ballas:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_ballas:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_ballas:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_ballas:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_ballas:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_ballas:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_ballas:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_ballas:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_ballas:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ballas:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ballas:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_ballas:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_ballas:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_ballas:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_ballas:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_ballas:hasEnteredEntityZone', function(entity)
...
AddEventHandler('esx_ballas:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_ballas:handcuff')
AddEventHandler('esx_ballas:handcuff', function()
...
AddEventHandler('esx_ballas:drag', function(cop)
...
AddEventHandler('esx_ballas:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_ballas:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_ballas:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(56,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ballas_actions') and (GetGameTimer() - GUI.Time) > 150 then
