...
RegisterServerEvent('esx_families:confiscatePlayerItem')
AddEventHandler('esx_families:confiscatePlayerItem', function(target, itemType, itemName, amount)
...
RegisterServerEvent('esx_families:getStockItem')
AddEventHandler('esx_families:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_families:putStockItems')
AddEventHandler('esx_families:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_families:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('esx_families:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_families:getStockItems', function(source, cb)
